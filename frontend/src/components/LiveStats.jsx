...
import { TrendingUp, Users, Calendar, Award, Heart, ShieldCheck, Trophy, Crown, Medal } from 'lucide-react';
...
export const LiveStats = ({ stats }) => {
  ...
  const totalDonors = stats?.total_donors || 0;
    ...
    <section id="stats" className="py-5 bg-white border-top border-bottom">
      <div className="container">
        ...
        <div className="text-center max-w-2xl mx-auto mb-5">
          ...
          <h2 className="fw-bold text-emerald-main display-6">മദ്രസ കളക്ഷൻ റാങ്കിംഗ് & ടോപ്പ് ദാതാക്കൾ</h2>
          <p className="text-muted">റേഞ്ചിനു കീഴിലുള്ള 17 മദ്രസകളുടെ തത്സമയ കളക്ഷൻ നിലയും ഉയർന്ന സംഭാവന നൽകിയ വ്യക്തികളുടെ പട്ടികയും.</p>
        </div>
        ...
        <div className="row g-4 mb-5">
          ...
          <div className="col-12 col-md-4 col-lg-2.4">
            <div className="p-4 rounded-4 bg-emerald-subtle border border-emerald-light border-opacity-30 text-center h-100 rahma-card">
              ...
              <span className="text-muted small fw-bold text-uppercase d-block">ആകെ ദാതാക്കൾ</span>
              <h4 className="fw-bold text-emerald-main mb-0 mt-1">{totalDonors} പേർ</h4>
            </div>
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="bg-light rounded-4 border p-4">
            <h6 className="fw-bold text-emerald-main mb-3">മറ്റുള്ള റേഞ്ച് മദ്രസകളുടെ കളക്ഷൻ റാങ്കിംഗ്</h6>
        ...
        <div>
          <div className="d-flex align-items-center justify-content-between mb-4">
            <div className="d-flex align-items-center gap-2">
              ...
              <h4 className="fw-bold text-emerald-main mb-0">ഏറ്റവും ഉയർന്ന സംഭാവന നൽകിയ വ്യക്തികൾ (Top Donors)</h4>
            </div>
          ...
          {topDonors.length === 0 ? (
            <div className="p-4 bg-light rounded-4 border text-center text-muted">
              സംഭാവനകൾ ചേർക്കപ്പെടുന്നതോടെ ടോപ്പ് ദാതാക്കളുടെ വിവരങ്ങൾ ഇവിടെ തത്സമയം കാണാം.
            </div>
          ) : (
                ...
                <div key={donor.id || idx} className="col-md-6 col-lg-4">
                  <div className="p-4 bg-white rounded-4 border shadow-sm h-100 position-relative rahma-card">
                    <div className="d-flex align-items-center justify-content-between mb-2">
                      <span className="badge badge-gold">Top Donor #{idx + 1}</span>
